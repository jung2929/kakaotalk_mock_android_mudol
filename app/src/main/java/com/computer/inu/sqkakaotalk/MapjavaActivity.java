...
public class MapjavaActivity extends AppCompatActivity {
    ...
    static final String API_KEY = "d752d08c98a48b862f5747ba31e015fd";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mapjava);

        // Using TedPermission library
        PermissionListener permissionlistener = new PermissionListener() {
            @Override
            public void onPermissionGranted() {
                Toast.makeText(MapjavaActivity.this, "권한 허가", Toast.LENGTH_SHORT).show();

                // MapView 객체생성 및 API Key 설정
                MapView mapView = new MapView(MapjavaActivity.this);
            ...
            public void onPermissionDenied(ArrayList<String> deniedPermissions) {
                Toast.makeText(MapjavaActivity.this, "권한 거부\n" + deniedPermissions.toString(), Toast.LENGTH_SHORT).show();
            }
